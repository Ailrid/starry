 ...
 * @LastEditTime: 2026-02-05 11:57:03
...
import { BaseMessage, Hook, Middleware, MessageIdentifier } from './types'
 ...
 * 外部导出：类型推导完善的挂载函数
 */
export const onBeforeExecute = <T extends BaseMessage>(type: MessageIdentifier<T>, hook: Hook<T>) =>
  ExecutionTask.addBefore(type, hook)

export const onAfterExecute = <T extends BaseMessage>(type: MessageIdentifier<T>, hook: Hook<T>) =>
